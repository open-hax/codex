---
uuid: "inbox-workspaces-openhax-codex-codex-auth-kanban-inbox-workspaces-openhax-codex-codex-auth-spec-plugin-name-rename-md"
title: "Plugin name rename to npm package name"
status: incoming
priority: P3
labels: ["specs", "migrated-spec"]
created_at: "2026-05-29T04:01:26.121Z"
source: "inbox/workspaces/openhax-codex/codex-auth/spec/plugin-name-rename.md"
category: "specs"
---

> Source: `inbox/workspaces/openhax-codex/codex-auth/spec/plugin-name-rename.md`
> Migrated-to-kanban: `inbox/workspaces/openhax-codex/codex-auth/kanban/plugin-name-rename.md`
