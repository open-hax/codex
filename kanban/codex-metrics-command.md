---
uuid: "inbox-workspaces-openhax-codex-codex-auth-kanban-inbox-workspaces-openhax-codex-codex-auth-spec-codex-metrics-command-md"
title: "/codex-metrics Command Specification"
status: incoming
priority: P3
labels: ["specs", "migrated-spec"]
created_at: "2026-05-29T04:01:26.117Z"
source: "inbox/workspaces/openhax-codex/codex-auth/spec/codex-metrics-command.md"
category: "specs"
---

> Source: `inbox/workspaces/openhax-codex/codex-auth/spec/codex-metrics-command.md`
> Migrated-to-kanban: `inbox/workspaces/openhax-codex/codex-auth/kanban/codex-metrics-command.md`
