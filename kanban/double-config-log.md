---
uuid: "inbox-workspaces-openhax-codex-codex-auth-kanban-inbox-workspaces-openhax-codex-codex-auth-spec-double-config-log-md"
title: "Double plugin config log at startup"
status: incoming
priority: P3
labels: ["specs", "migrated-spec"]
created_at: "2026-05-29T04:01:26.113Z"
source: "inbox/workspaces/openhax-codex/codex-auth/spec/double-config-log.md"
category: "specs"
---

> Source: `inbox/workspaces/openhax-codex/codex-auth/spec/double-config-log.md`
> Migrated-to-kanban: `inbox/workspaces/openhax-codex/codex-auth/kanban/double-config-log.md`
