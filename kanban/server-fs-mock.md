---
uuid: "inbox-workspaces-openhax-codex-codex-auth-kanban-inbox-workspaces-openhax-codex-codex-auth-spec-server-fs-mock-md"
title: "Fix hanging server tests due to `node:fs` mock"
status: incoming
priority: P3
labels: ["specs", "migrated-spec"]
created_at: "2026-05-29T04:01:26.130Z"
source: "inbox/workspaces/openhax-codex/codex-auth/spec/server-fs-mock.md"
category: "specs"
---

> Source: `inbox/workspaces/openhax-codex/codex-auth/spec/server-fs-mock.md`
> Migrated-to-kanban: `inbox/workspaces/openhax-codex/codex-auth/kanban/server-fs-mock.md`
