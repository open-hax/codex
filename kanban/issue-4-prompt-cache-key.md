---
uuid: "inbox-workspaces-openhax-codex-codex-auth-kanban-inbox-workspaces-openhax-codex-codex-auth-spec-issue-4-prompt-cache-key-md"
title: "Issue 4 – Fork-aware prompt_cache_key and non-structural overrides"
status: incoming
priority: P3
labels: ["specs", "migrated-spec"]
created_at: "2026-05-29T04:01:26.123Z"
source: "inbox/workspaces/openhax-codex/codex-auth/spec/issue-4-prompt-cache-key.md"
category: "specs"
---

> Source: `inbox/workspaces/openhax-codex/codex-auth/spec/issue-4-prompt-cache-key.md`
> Migrated-to-kanban: `inbox/workspaces/openhax-codex/codex-auth/kanban/issue-4-prompt-cache-key.md`
