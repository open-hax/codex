---
uuid: "inbox-workspaces-openhax-codex-codex-auth-kanban-inbox-workspaces-openhax-codex-codex-auth-spec-retarget-workflow-fix-md"
title: "PR Auto Base Retarget Fix"
status: incoming
priority: P3
labels: ["specs", "migrated-spec"]
created_at: "2026-05-29T04:01:26.114Z"
source: "inbox/workspaces/openhax-codex/codex-auth/spec/retarget-workflow-fix.md"
category: "specs"
---

> Source: `inbox/workspaces/openhax-codex/codex-auth/spec/retarget-workflow-fix.md`
> Migrated-to-kanban: `inbox/workspaces/openhax-codex/codex-auth/kanban/retarget-workflow-fix.md`
