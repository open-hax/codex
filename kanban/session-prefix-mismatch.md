---
uuid: "inbox-workspaces-openhax-codex-codex-auth-kanban-inbox-workspaces-openhax-codex-codex-auth-spec-session-prefix-mismatch-md"
title: "Session cache prefix mismatch – bridge injection"
status: incoming
priority: P3
labels: ["specs", "migrated-spec"]
created_at: "2026-05-29T04:01:26.120Z"
source: "inbox/workspaces/openhax-codex/codex-auth/spec/session-prefix-mismatch.md"
category: "specs"
---

> Source: `inbox/workspaces/openhax-codex/codex-auth/spec/session-prefix-mismatch.md`
> Migrated-to-kanban: `inbox/workspaces/openhax-codex/codex-auth/kanban/session-prefix-mismatch.md`
